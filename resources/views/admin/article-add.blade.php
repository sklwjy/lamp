...
<title>微博发布</title>
<meta name="keywords" content="微博，微博达人">
...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="articlecolumn" class="select">
					...
					<option value="2">幽默</option>
					<option value="3">八卦</option>
					<option value="4">时政</option>
				</select>
				</span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">自定义关键词：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">微博配图：</label>
			<div class="formControls col-xs-8 col-sm-9">
