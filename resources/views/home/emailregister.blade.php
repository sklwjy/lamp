...
<div id="container">
    ...
    <div id="banner">
        ...
        <div id="left">
            <!--页面左部表单设置-->
            <form id="LoginForm" action="{{url('emailregister')}} " method="post">
                @if (count($errors) > 0)
                ...
                <table width="565" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="le"></td>
                        <td class="ld">密码</td>
                        <td class="if"><input name="user_password" type="password" class="la" /></td>
<!--                        <td><a href="javascript:;" onclick="sendcode();">发送验证码</a>-->
<!--                        </td>-->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="lc" id="button">登  录</button>
                        </td>
                        <td></td>
                    </tr>
                </table>
...
//                alert(phone);
                $.post("{{ url('sendcode')  }}",{ 'phone':$phone,'_token':'{{ csrf_token() }} '},
                    function(data) {
                        console.log(data);//Object {phone: "admin"}
