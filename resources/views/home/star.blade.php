...
<!-- 下部容器头部注内 DIV 结束 -->   
   ...
   <!-- banner顶部部分 -->
     <div id="bannerTop">
       <img src="images/huang.gif" width="97" height="98" alt="" />
     </div>
    <!-- bannerWord字的部分 -->
     <div id="bannerWord">
       <font color="#000000" size="3"><b>黄海波</b></font><img src="images/1.gif" width="17" height="15" alt="" />
       <br/><font color="#0066FF">http://t.lingbu.com/黄海波</font>
     </div>
     <!-- 加关注 -->
     <div id="bannerFocus">
     ...
     <!-- banner微博部分 -->
     <div class="bannerAttention">
      <font color="#005dc3" size="3"><b>黄海波</b></font>&nbsp;&nbsp;&nbsp;&nbsp;秦淮河畔？
      <br />
     <img src="images/lake.gif" width="135" height="104" alt="" />
     <br /><font color="#cccccc">08月01日  &nbsp;&nbsp;23:48   &nbsp;&nbsp;来自iPhone客户端</font>
     </div>
     <div class="bannerAttention">
      <font color="#005dc3" size="3"><b>黄海波</b></font>&nbsp;&nbsp;&nbsp;&nbsp;瞧瞧人家的宣传部长
      <br />
     <img src="images/famale.gif" width="135" height="104" alt="" />
     <br /><font color="#cccccc">08月01日  &nbsp;&nbsp;18:16   &nbsp;&nbsp;来自iPhone客户端</font>
     </div>
     <div class="bannerAttention">
      <font color="#005dc3" size="3"><b>黄海波</b></font>&nbsp;&nbsp;&nbsp;&nbsp;13世纪元朝两次出兵征服日本，皆败未果。后来出家之人将散落的蒙古兵的坟聚在一起，修此坟冢；后来还有一个蒙古军供养塔，上面写着："愿以此功德，普及与一切，我等于众生，皆共成佛道。"但是注意仍成为"元寇"，一码是一码。为敌军修墓地在韩国也见过，想起中国：沉思。。。。。。
      <br />
     <img src="images/4.jpg" width="135" height="104" alt="" />
     <br /><font color="#cccccc">07月29日  &nbsp;&nbsp;22:38   &nbsp;&nbsp;来自iPhone客户端</font>
     </div>
     <div class="bannerAttention1">
      <font color="#005dc3" size="3"><b>黄海波</b></font>&nbsp;&nbsp;&nbsp;&nbsp;国父1913在福冈"世界和平"题字原物，安川家族今天为我们特别展示！
      <br />
     <img src="images/tu1.jpg" width="135" height="104" alt="" />
     <br /><font color="#cccccc">07月29日  &nbsp;&nbsp;10:32   &nbsp;&nbsp;来自iPhone客户端</font>
     </div>
     <div id="look">
       <form id="form2" name="form2" method="post" action="">
         <label id="查看更多">
           <input name="btn2" type="submit" class="btn2" id="btn2" value="查看更多" />
         </label>
       </form>
     </div>
  </div> 
