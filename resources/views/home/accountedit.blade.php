...
<br />
                ...
                <tr>
                    ...
                    <td width="425" height="49"><label>
                         <input name="userinfo_email" type="text" class="n3" id="textfield3" value="{{ $userinfo->userinfo['userinfo_email'] }}"/>
                             </label></td>
                </tr>
                <tr>
            ...
            {{--你在哪？让你周围的更多的朋友找到你</label></td>--}}
                ...
                <tr>
                    ...
                    <td width="425" height="68"><label>
                        <input name="userinfo_web" type="text" class="n1" id="textfield4" value="{{ $userinfo->userinfo->userinfo_web }}"/>
                        <br />
                ...
                <tr>
                    ...
                    <td width="425" height="180">
                       <div>
                            <label>
                                  <textarea name="userinfo_intro" class="n4" type="text" id="textfield5" value="{{ $userinfo->userinfo['userinfo_intro'] }}"></textarea>
                            </label>
                       </div></td>
                </tr>
                <!-- 隐私 -->
